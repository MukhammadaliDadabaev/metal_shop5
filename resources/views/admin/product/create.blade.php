               ...
               <div class="col-12">
                   <form action="{{ route('admin.product.store') }}" method="POST" enctype="multipart/form-data">
                       ...
                       <div class="form-group">
                           ...
                           <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" id="title1" placeholder="Title">
                           @error('title')
                       ...
                       <div class="form-group">
                           ...
                           <textarea class="form-control" name="content" cols="12" rows="3" id="content1" placeholder="Content"></textarea>
                           @error('content')
                           <div class="text-danger">To`ldirish shartbr 👆<br> {{ $message }}</div>
                           @enderror
                       </div>
                       ...
                       <div class="form-group">
                           ...
                           <textarea class="form-control @error('description') is-invalid @enderror" name="description" cols="15" rows="5" id="desc1" value="{{ old('description') }}"
                       ...
                       <div class="form-group">
                           ...
                           <input type="number" class="form-control @error('number') is-invalid @enderror" name="price" id="price1" value="{{ old('price') }}"
                                  placeholder="Summa">
                           @error('price')
                           <div class="text-danger">To`ldirish shartbr 👆<br> {{ $message }}</div>
                           @enderror
